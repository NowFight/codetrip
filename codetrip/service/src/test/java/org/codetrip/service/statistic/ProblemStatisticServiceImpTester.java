 ...
 */
public class ProblemStatisticServiceImpTester {
    private ProblemStatisticService problemStatistic;
    ...
    public void init() {
        ...
        problemStatistic = (ProblemStatisticService) beanFactory.getBean("ProblemStatisticService");
    }
